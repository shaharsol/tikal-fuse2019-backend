...
router.get('/delete-pod', function(req, res, next) {
  const headers = {
  ...
  request.delete('http://C69B579D37C61467561FEA464E69A7C8.sk1.eu-central-1.eks.amazonaws.com/api/v1/namespaces/default/pods/carts-77988f85cc-wvpm4',{headers: headers},function(error,response,body){
    console.log(error)
